...
namespace pkNX.Game
{
    ...
    public class GameFileMapping
    {
        ...
        private static readonly GameFileReference[] PLA =
        {
            ...
            //throw_prohibition_table.bin
            //throw_style_dictionary.bin
            new(GameFile.ThrowableBaitParam     , ContainerType.SingleFile, "bin", "capture", "throwable_bait_param_dictionary.bin"),
            //throwable_collision_shape_dictionary.bin
            new(GameFile.ThrowableParam         , ContainerType.SingleFile, "bin", "capture", "throwable_param_table.bin"),
            //throwable_physics_material_dictionary.bin
            ...
            new(GameFile.TestConfig                    , ContainerType.SingleFile, "bin", "appli", "map", "data", "map_icon_pos_table.bin"),
